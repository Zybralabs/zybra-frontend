...
export const ABSTRACTION_ENTRY_POINT: Record<number, string> = {
  1: "0xERC7540VaultMainnet", // Mainnet
  11155111: "0xERC7540VaultRinkeby", // Rinkeby
  8453: "0xERC7540VaultBase", // Base
};
...
export const CENTRIFUGE_ROUTER_ADDRESS: Record<number, string> = {
  ...
  11155111: "0xCentrifugeRouterRinkeby", // Rinkeby
...
export const USDC_ADDRESS: Record<number, string> = {
  ...
  11155111: "0x4dbcdf9b62e891a7cec5a2568c3f4faf9e8abe2b", // Rinkeby
