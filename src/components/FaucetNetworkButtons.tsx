...
const FaucetNetworkButtons: React.FC<{
  ...
  return (
    <div className="space-y-4">
      {buttons.map((button) => (
        ...
        >
          <div className="absolute top-0 right-0 bg-gradient-to-bl from-blue-500/10 to-transparent w-32 h-32 -mr-8 -mt-8 rounded-full"></div>
          <div className="w-10 h-10 rounded-full bg-[#0052FF] flex items-center justify-center text-xs font-bold shadow-lg mt-1 relative">
            {button.icon}
          </div>
...
export default FaucetNetworkButtons;
