  ...
  return (
    <div className="bg-[#001C29] text-white p-6 rounded-xl w-2xl flex flex-col justify-between">
      ...
      <div className="grid grid-cols-3 gap-8 mb-8">
        ...
        <div>
          <div className="grid grid-cols-3 gap-24 mb-0">
            <div className="text-white text-md mb-0"></div>
            <div className="text-white text-md mb-0">APY</div>
            <div className="text-white text-md mb-0">Min.Invesment</div>
          </div>
          <div className="grid grid-cols-3 gap-24 mb-0">
            <div className="text-white text-md mb-0">Junior.</div>
            <div className="text-white text-md mb-0">8%</div>
            <div className="flex gap-2 w-full items-center text-white text-md mb-0">
              $200k <span className="cursor-pointer text-sm text-gray-400">target</span>
            </div>
          </div>
          <div className="grid grid-cols-3 gap-24 mb-0">
            <div className="text-white text-md mb-0">Senior.</div>
            <div className="text-white text-md mb-0">16%</div>
            <div className="flex gap-2 w-full items-center text-white text-md mb-0">
              $200k <span className="cursor-pointer text-sm text-gray-400">target</span>
            </div>
          </div>
